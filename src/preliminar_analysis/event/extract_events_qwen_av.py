...
GPU_FISICA = 3
OUTPUT_FILE = "eventi_qwen_av.json"
...
def load_model(args):
    ...
    return model, Qwen2_5OmniProcessor.from_pretrained(args.model)
...
def run_model(
    ...
    conversation = [
        {
            ...
            "content": [{
                "type": "text",
                "text": (
                    "Sei un annotatore di eventi audiovisivi. "
    ...
    audios, images, videos = process_mm_info(
        conversation,
        use_audio_in_video=audio_present,
    )
    inputs = processor(
        text=text,
        audio=audios,
    ...
    return (
        ...
        {"integrazione_modalita": "video con audio nativo"},
    )
